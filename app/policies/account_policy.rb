...
class AccountPolicy < ApplicationPolicy
  ...
  def feature?
    record.featureable_by?(current_account) &&
      following_or_self? &&
      !current_account.blocking?(record) &&
      !current_account.blocked_by?(record)
  end
  ...
  def following_or_self?
    current_account == record || current_account.following?(record)
  end
end
